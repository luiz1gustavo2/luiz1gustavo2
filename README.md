...
#### Eu sou formado em Análise e Desenvolvimento de Sistemas e durante esse período eu venho estudando para me tornar um Desenvolvedor Fullstack. Dentre as várias vertentes dentro do mercado de tecnologia, o Frontend sempre chamou minha atenção, porém eu estou estudando e estou disposto a trabalhar tanto com Back, Front ou Fullstack. Eu tento não me prender á uma linguagem ou framework, acredito que o ideal seja aprender os Padrões de Design e ter uma boa lógica de programação para que dessa forma seja possível desenvolver códigos eficientes em qualquer linguagem.

#### Sou uma pessoa paciente, focada e bastante comunicativa quando necessário, eu sempre gostei de tomar a frente da situação quando dentro de um trabalho em grupo, por isso acredito que um dia eu possa ter o necessário para ser um líder de projeto.
